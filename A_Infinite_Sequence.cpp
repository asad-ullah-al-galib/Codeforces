...
void answer()
{
    int n,m,l;
    cin>>n>>m>>l;
    if(l==0 and n==m) cout<<"YES"<<endl;
    else if((m>n and l<0) or (n>m and l>0)) cout<<"NO"<<endl;
    else if((l!=0 and (m-n)%l==0)) cout<<"YES"<<endl;
    else cout<<"NO"<<endl;

    //vul hoise bhai tore solve korte bose. maf kore de bhai
    // amar cheter ba*al
}
int main()
{
