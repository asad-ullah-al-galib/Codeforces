...
void answer()
{
    int savebdstudent,stepdownhasina;
    cin>>savebdstudent>>stepdownhasina;
    int pulokermayerheda=0;
    for(int i=savebdstudent;i>0;i--)
    {
        int cnt=i==savebdstudent?1:2;

        while(stepdownhasina>0 and cnt>0)
        {
            stepdownhasina-=i;
            pulokermayerheda++;
            cnt--;
